...
class TestHomepageViewModels(unittest.TestCase):
    ...
    def test_inject_styles_uses_apple_workbench_tokens(self):
        ...
        self.assertRegex(css, r"\.shell-title\s*\{[^}]*font-weight:\s*600;")
        self.assertRegex(css, r"\.panel-title\s*\{[^}]*font-weight:\s*600;")
        self.assertRegex(css, r"\.shell-copy\s*\{[^}]*font-size:\s*0\.82rem;")
        self.assertRegex(css, r"\.shell-copy\s*\{[^}]*margin:\s*0\.18rem 0 0;")
        self.assertRegex(css, r"\.top-shell\s*\{[^}]*padding:\s*0\.14rem 0 0\.02rem;")
        ...
        self.assertRegex(css, r"\.header-meta-card\s*\{[^}]*padding:\s*0\.18rem 0\.24rem;")
        ...
        self.assertRegex(css, r"\.conversation-thread\s*\{[^}]*gap:\s*0\.62rem;")
        self.assertRegex(css, r"\.summary-hero\.results-shell\s*\{[^}]*margin-bottom:\s*var\(--workspace-stack-gap\);")
        self.assertRegex(css, r"\.insight-card\.insight-shell\s*\{[^}]*margin-bottom:\s*var\(--workspace-stack-gap\);")
        self.assertRegex(css, r"\.section-card\s*\{[^}]*margin-bottom:\s*var\(--workspace-stack-gap\);")
        self.assertRegex(css, r"\.plain-section\.follow-up-shell\s*\{[^}]*margin-top:\s*var\(--workspace-stack-gap\);")
        ...
        self.assertRegex(css, r"\.summary-copy\s*\{[^}]*font-size:\s*0\.68rem !important;")
        self.assertRegex(css, r"\.metric-label\s*\{[^}]*font-size:\s*0\.68rem;")
    ...
    def test_build_chart_layout_keeps_plot_compact(self):
        ...
        self.assertEqual(layout["height"], 280)
